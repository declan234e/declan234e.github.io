    ...
    Game: { // Our overrides
        UpdateMenu: () => {
            ...
            if (Game.onMenu == 'prefs') {
                ...
                fragment.appendChild(Crustulum.Menu.actionButton('giveUnlimitedCookies','Give Unlimited Cookies','Gives you unlimited cookies.', Crustulum.Actions.giveUnlimitedCookies));
                fragment.appendChild(Crustulum.Menu.actionButton('removeAllCookies','Remove all cookies','Removes all cookies (you might have to refresh the page).', Crustulum.Actions.removeAllCookies));
                ...
                fragment.appendChild(Crustulum.Menu.actionButton('unlockAllThings','unlock everything','Gives you every thing in the game.', Crustulum.Actions.unlockAllThings));
                fragment.appendChild(Crustulum.Menu.heading('about'));
